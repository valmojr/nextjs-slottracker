...
export const randomEventsExample: Event[] = [
  {
    ...
    thumbnail:
      'https://media.discordapp.net/attachments/1132783472667275346/1132783472851828746/image.png',
  ...
  },
  {
    ...
    thumbnail:
      'https://media.discordapp.net/attachments/1138297698219479201/1138297698353688686/overview.jpg',
